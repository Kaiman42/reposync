...
HOOKS = ['post-commit', 'post-merge', 'post-checkout', 'post-rewrite', 'post-applypatch', 'post-reset', 'post-update', 'post-switch']
...
def install_for_repo(repo: str, force: bool=False):
    if not force and repo_hook_version(repo) == HOOK_VERSION:
        return False
    for hook in HOOKS:
